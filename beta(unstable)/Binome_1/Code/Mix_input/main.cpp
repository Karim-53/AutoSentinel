...
ull dist[nax];
int BT[nax];
double dijkstra(int src, int snk){//TODO: passer à min coast max flow (pas sur que c'est mieux min risque max speed)
...
//DONE: faire bouger le pt src d'un pas à chaque iteration
src_x+=vec_dep_x;
src_y+=vec_dep_y;
    return 0;
...
//TODO: choisir entre les 2 trajet: moin de risque ou plus directe, var priorité
