    ...
    while 1:
        ...
        if(count in unusualFrames):
            ...
            for blockNum in unusual[count]:
                ...
                cv2.rectangle(uFrame,(math.floor(x1),math.floor(y1)),(math.floor(x2),math.floor(y2)),(0,0,255),1)
...
def constructMinDistMatrix(megaBlockMotInfVal,codewords, noOfRows, noOfCols, vid):
    ...
    #threshold = 0.099167467697
    #threshold = 0.75195096797892
    ...
    n = 2
    minDistMatrix = np.zeros((len(megaBlockMotInfVal[0][0]),math.floor(noOfRows/n),math.floor(noOfCols/n)))
...
if __name__ == '__main__':
    ...
    '''
    testSet = [r"Dataset\videos\scene1\testing.avi"]
